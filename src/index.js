  ...
  constructor({ data, config, api, readOnly }) {
    ...
    this.settings = [
      ...
      },
      {
        ...
        icon: '<svg width="17px" height="17px" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 504 504" xml:space="preserve" enable-background="new 0 0 504 504"><path d="M232.2 300.6H504V316.6H232.2z"/><path d="M232.2 366.7H504V382.7H232.2z"/><path d="M232.2 433H504V449H232.2z"/><path d="M232.2 55H504V71H232.2z"/><path d="M232.2 121.2H504V137.2H232.2z"/><path d="M232.2 187.4H504V203.4H232.2z"/><path d="M78.6 294.7a79.3 79.3 0 0 0-78.6 80C0 419 35.2 455 78.6 455a79.3 79.3 0 0 0 78.6-80.1c0-44.2-35.2-80.1-78.6-80.1zm0 144.1a63.4 63.4 0 0 1-62.6-64c0-35.4 28-64.1 62.6-64.1 34.5 0 62.6 28.7 62.6 64s-28.1 64.1-62.6 64.1zM78.6 49.1C35.2 49.1 0 85 0 129.2s35.2 80.1 78.6 80.1c43.4 0 78.6-35.9 78.6-80S122 49 78.6 49zm0 144.2a63.4 63.4 0 0 1-62.6-64C16 93.8 44 65 78.6 65c34.5 0 62.6 28.8 62.6 64.1s-28.1 64.1-62.6 64.1z"/></svg>',
        default: config.defaultStyle === 'none' || false,
      },
    ];
